...
const Hero = () => {
  ...
  return (
    // <>
    //   <Container classNameNameName="flex flex-wrap  ">
    //     <div classNameNameName="flex items-center w-full lg:w-1/2 ">
    //       <div classNameNameName="max-w-2xl mb-8 text-center lg:w-full lg:py-20 lg:text-left">
    //         <h1 classNameNameName="text-4xl font-bold leading-snug tracking-tight text-[#50d71e] lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight ">
    //           Swipe Your Dream
    //         </h1>
    //         <h1 classNameNameName="text-4xl font-bold leading-snug tracking-tight text-[#50d71e] lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight ">
    //           Tech Jobs
    //         </h1>
    //         <p classNameNameName="py-5 text-xl leading-normal text-[#50d71e] lg:text-xl xl:text-2xl ">
    //           Hand-picked jobs reachable in with a single swipe. Anonyms till
    //           the match. No resume&apos;s and motivation letters. Top companies
    //           only.
    //         </p>

    //         <div classNameNameName="max-w-6xl mx-auto ">
    //           <div
    //           //  ref={addToScrollRevealRef}
    //           >
    //             <NewsletterForm
    //               classNameNameName="mx-auto mt-8 max-w-md lg:mx-0 "
    ...
    //       </div>
    //     </div>
    //     <div classNameNameName="flex items-center justify-center w-full lg:w-1/2">
    ...
    //           height="300"
    //           data-aos="fade-left"
    //           // classNameNameName="w-8"
    //         />
    //       </div>
    //     </div>
    //   </Container>
    //   <Container>
    //     <div classNameNameName="flex flex-col justify-center">
    //       <div classNameNameName="text-xl text-center text-gray-700 dark:text-white">
    //         Trusted by <span classNameNameName="text-accent font-bold">2000+</span>{" "}
    //         users worldwide
    //       </div>
    //     </div>
    //   </Container>
    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-10">
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight ">Get your dream job with <span className="text-blue-600">DevSwipe</span></h1>
...
<a className="flex items-center bg-[#000000] rounded-xl py-3 px-3 sm:px-4 transition-all hover:shadow-primary-hover mr-2 sm:mr-5" href=""><span className="pr-3"><svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 28.9958V4.9125C4 4.07667 4.48167 3.34 5.19 3L19.1442 16.9542L5.19 30.9083C4.48167 30.5542 4 29.8317 4 28.9958ZM23.5642 21.3742L8.32083 30.1858L20.3483 18.1583L23.5642 21.3742ZM28.31 15.2683C28.7917 15.6508 29.1458 16.2458 29.1458 16.9542C29.1458 17.6625 28.8342 18.2292 28.3383 18.6258L25.0942 20.4958L21.5525 16.9542L25.0942 13.4125L28.31 15.2683ZM8.32083 3.7225L23.5642 12.5342L20.3483 15.75L8.32083 3.7225Z" fill="white"></path></svg></span><span className="font-bold text-white text-lg"><span className="block text-xs text-white opacity-70">Get it on</span>Google Play</span></a>
            {/* <a className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
              Contact sales team
            </a> */}

<a href="javascript:void(0)" class="flex items-center bg-black  rounded-xl py-3 px-3 sm:px-4 transition-all hover:shadow-black-hover"><span class="pr-3 text-white "><svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26.5058 27.625C25.33 29.3817 24.0833 31.0958 22.185 31.1242C20.2866 31.1667 19.6775 30.005 17.5241 30.005C15.3566 30.005 14.6908 31.0958 12.8916 31.1667C11.0358 31.2375 9.6333 29.2967 8.4433 27.5825C6.0208 24.0833 4.16497 17.6375 6.6583 13.3025C7.8908 11.1492 10.1008 9.78916 12.495 9.74666C14.3083 9.71833 16.0366 10.9792 17.1558 10.9792C18.2608 10.9792 20.3575 9.46333 22.5533 9.68999C23.4741 9.73249 26.0525 10.0583 27.71 12.495C27.5825 12.58 24.6358 14.3083 24.6641 17.8925C24.7066 22.1708 28.4183 23.6017 28.4608 23.6158C28.4183 23.715 27.8658 25.6558 26.5058 27.625ZM18.4166 4.95833C19.4508 3.78249 21.165 2.88999 22.5816 2.83333C22.7658 4.49083 22.1 6.16249 21.1083 7.35249C20.1308 8.55666 18.5158 9.49166 16.9291 9.36416C16.7166 7.73499 17.51 6.03499 18.4166 4.95833Z" fill="currentColor"></path></svg></span><span class="font-bold text-white  text-lg"><span class="block text-xs text-white  opacity-70 dark:opacity-70">Download from</span>App Store</span></a>
          </div>
    
          <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            <div className="py-5">
              <div className="flex space-x-1">
                <svg className="h-4 w-4 text-gray-800 " width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="h-4 w-4 text-gray-800 d" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M27.0352 1.6307L33.9181 16.3633C34.2173 16.6768 34.5166 16.9903 34.8158 16.9903L50.0779 19.1845C50.9757 19.1845 51.275 20.4383 50.6764 21.0652L39.604 32.3498C39.3047 32.6632 39.3047 32.9767 39.3047 33.2901L41.998 49.2766C42.2973 50.217 41.1002 50.8439 40.5017 50.5304L26.4367 43.3208C26.1375 43.3208 25.8382 43.3208 25.539 43.3208L11.7732 50.8439C10.8754 51.1573 9.97763 50.5304 10.2769 49.59L12.9702 33.6036C12.9702 33.2901 12.9702 32.9767 12.671 32.6632L1.29923 21.0652C0.700724 20.4383 0.999979 19.4979 1.89775 19.4979L17.1598 17.3037C17.459 17.3037 17.7583 16.9903 18.0575 16.6768L24.9404 1.6307C25.539 0.69032 26.736 0.69032 27.0352 1.6307Z" fill="currentColor"/>
                </svg>
                <svg className="h-4 w-4 text-gray-800 " width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M27.0352 1.6307L33.9181 16.3633C34.2173 16.6768 34.5166 16.9903 34.8158 16.9903L50.0779 19.1845C50.9757 19.1845 51.275 20.4383 50.6764 21.0652L39.604 32.3498C39.3047 32.6632 39.3047 32.9767 39.3047 33.2901L41.998 49.2766C42.2973 50.217 41.1002 50.8439 40.5017 50.5304L26.4367 43.3208C26.1375 43.3208 25.8382 43.3208 25.539 43.3208L11.7732 50.8439C10.8754 51.1573 9.97763 50.5304 10.2769 49.59L12.9702 33.6036C12.9702 33.2901 12.9702 32.9767 12.671 32.6632L1.29923 21.0652C0.700724 20.4383 0.999979 19.4979 1.89775 19.4979L17.1598 17.3037C17.459 17.3037 17.7583 16.9903 18.0575 16.6768L24.9404 1.6307C25.539 0.69032 26.736 0.69032 27.0352 1.6307Z" fill="currentColor"/>
