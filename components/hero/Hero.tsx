...
// import background_video from '../../public/vid/Blue Technology App New Features Animated Video.mp4';
...
const Hero = () => {
  ...
  //   // Controleer of e een event object is en preventDefault bestaat
            ...
            <div className="max-w-6xl mx-auto ">
              ...
              {/* <div className=" ">
                <input
                  ...
                  type="email"
                  autoComplete="email"
                  className="border border-gray-600 w-1/4 sm:w-full pr-2 pl-2 py-3 mt-2 rounded-md text-gray-800 font-semibold hover:border-gray-900"
                ></input>{" "}
                <a
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            ...
            {/* <video
              ...
              playsInline
              style={{
                backgroundImage: `url(https://assets-global.website-files.com/6398aa01513091536e5f3c96/6398b1144c7ac778b8459580_Studio Web Update-poster-00001.jpg)`,
              }}
            >
              <source src="/vid/hero_video.mp4" type="video/mp4" />
              <source src="/vid/hero_video.mp4" type="video/webm" />
            </video> */}
          </div>
        </div>
      </Container>
