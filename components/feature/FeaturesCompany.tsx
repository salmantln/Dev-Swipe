  ...
  return (
    <section className="mt-24 md:mt-40 text-center"           data-aos="fade-in">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4 items-center justify-items-center mx-auto max-w-4xl">
        <Image className="md:order-1" width={100} height={100} src="/img/potential.svg" alt="feature_1" />
        ...
        <Image className="md:order-2" width={100} height={100}  src="/img/enterprise.svg" alt="feature_2" />
        ...
        <Image className="md:order-3" width={100} height={100}  src="/img/matches.svg" alt="feature_3" />
