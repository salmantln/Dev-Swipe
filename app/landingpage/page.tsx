            ...
            <nav>
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-50 flex justify-between py-8">
                ...
                <div className="flex items-center gap-6">
                  ...
                  ></div>
                  <a
                    className="inline-flex justify-center rounded-lg border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm outline-2 outline-offset-2 transition-colors border-gray-300 text-gray-700 hover:border-gray-400 active:bg-gray-100 active:text-gray-700/80 hidden lg:block"
                    variant="outline"
                    color="gray"
                    href="/login"
                  >
                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                  <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                    ...
                    <p className="mt-6 text-lg text-gray-600">
                      ...
                      insiders, you’ll know exactly when to buy to maximize
                                  ...
                                  <div className="mt-3 rounded-lg bg-gray-50 ring-1 ring-inset ring-black/5">
                                    ...
                                    >
                                      ...
                                      <rect
                                        ...
                                        width="0px"
                                        height="144"
                                        fill="url(#:Rt58rqnla:-gradient)"
                                        clip-path="url(#:Rt58rqnla:-clip)"
                                        opacity="0.5"
                                      ></rect>
                                      <path
                    ...
                    <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                          ...
                          <div className="flex flex-col w-full">
                            ...
                            <div className="mt-6 px-4 text-white">
                              ...
                              <div className="text-sm text-gray-500">
                                Get tips{" "}
                                <span className="text-white">5s sooner</span>
                                for every invite.
                              </div>
                            </div>
                            <div className="mt-6 flex-auto rounded-t-2xl bg-white">
                      ...
                      <div className="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur sm:p-10">
                        ...
                        <p className="mt-2 text-sm text-gray-400">
                          ...
                          notifications 5 seconds sooner. And it’s 10 seconds if
                  ...
                  <div className="w-full flex-none snap-center px-4 sm:px-6">
                    <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                      ...
                      <div className="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur sm:p-10">
                        ...
                        <p className="mt-2 text-sm text-gray-400">
                          Get a push notification every time we find out
                          something that’s going to lower the share price on
                          your holdings so you can sell before the information
                          hits the public markets.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="w-full flex-none snap-center px-4 sm:px-6">
                    <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                      ...
                      <div className="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur sm:p-10">
                        ...
                        <p className="mt-2 text-sm text-gray-400">
                          We hide your stock purchases behind thousands of
                          anonymous trading accounts, so suspicious activity can
                      ...
                      <div className="relative z-10 p-8">
                        ...
                        <h3 className="mt-6 text-lg font-semibold text-white">
                          <button
                            ...
                            id="headlessui-tabs-tab-:Rabdbqnla:"
                            role="tab"
                            type="button"
                            aria-selected="true"
                            tabIndex="0"
                    ...
                    <div className="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                      <div className="relative z-10 p-8">
                        ...
                        <h3 className="mt-6 text-lg font-semibold text-white">
                          <button
                            className="text-left ui-not-focus-visible:outline-none"
                            id="headlessui-tabs-tab-:Rajdbqnla:"
                            role="tab"
                            type="button"
                            aria-selected="false"
                            tabIndex="-1"
                    ...
                    <div className="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                      <div className="relative z-10 p-8">
                        ...
                        <h3 className="mt-6 text-lg font-semibold text-white">
                          <button
                            className="text-left ui-not-focus-visible:outline-none"
                            id="headlessui-tabs-tab-:Rardbqnla:"
                            role="tab"
                            type="button"
                            aria-selected="false"
                            tabIndex="-1"
                    ...
                    <div className="relative aspect-[366/729] z-10 mx-auto w-full max-w-[366px]">
                      ...
                      <div className="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                        <div
                          ...
                          id="headlessui-tabs-panel-:Rqldbqnla:"
                          role="tabpanel"
                          tabIndex="0"
                          data-headlessui-state="selected"
                        >
                ...
                >
                  <li className="rounded-2xl border border-gray-200 p-8">
                    ...
                    <p className="mt-2 text-gray-700">
                      Whether it’s $1 or $1,000,000, we can put your money to
                      work for you.
                    </p>
                  </li>
                  <li className="rounded-2xl border border-gray-200 p-8">
                    ...
                    <p className="mt-2 text-gray-700">
                      Invest in different industries to find the most
                      opportunities to win huge.
                    </p>
                  </li>
                  <li className="rounded-2xl border border-gray-200 p-8">
                    <svg
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
                <div className="mx-auto max-w-md sm:text-center">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    It takes 30 seconds to sign up. Download the app and create
                    an account today and we’ll send you a tip guaranteed to
                    double your first investment.
                  </p>
                ...
                <div className="mt-8 flex justify-center">
                  <div className="relative">
                    <div
                      ...
                      id="headlessui-radiogroup-:Rrbqnla:"
                      role="radiogroup"
                    >
                      <div
                        ...
                        id="headlessui-radiogroup-option-:Rqrbqnla:"
                        role="radio"
                        aria-checked="true"
                        tabIndex="0"
                      ...
                      <div
                        ...
                        id="headlessui-radiogroup-option-:R1arbqnla:"
                        role="radio"
                        aria-checked="false"
                        tabIndex="-1"
                        data-headlessui-state=""
                ...
                <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-10 sm:mt-20 lg:max-w-none lg:grid-cols-3">
                  <section className="flex flex-col overflow-hidden rounded-3xl p-6 shadow-lg shadow-gray-900/5 bg-white">
                    ...
                    <p className="mt-3 text-sm text-gray-700">
                      You’re new to investing but want to do it right. Get
                      started for free.
                    </p>
                  ...
                  <section className="flex flex-col overflow-hidden rounded-3xl p-6 shadow-lg shadow-gray-900/5 bg-white">
                    ...
                    <p className="mt-3 text-sm text-gray-700">
                      You’ve been investing for a while. Invest more and grow
                      your wealth faster.
                    </p>
                    <div className="order-last mt-6">
                      <ul
                  ...
                  <section className="flex flex-col overflow-hidden rounded-3xl p-6 shadow-lg shadow-gray-900/5 order-first bg-gray-900 lg:order-none">
                    ...
                    <p className="mt-3 text-sm text-gray-300">
                      You’ve got a huge amount of assets but it’s not enough. To
                      the moon.
                    </p>
                    <div className="order-last mt-6">
                      <ul
                ...
                >
                    ...
                    <ul role="list" className="space-y-10">
                      <li>
                        ...
                        <p className="mt-4 text-sm text-gray-700">
                          Our whole business depends on our tips being good, so
                          it’s in our best interest that they are. The results
                          of our customers speak for themselves, just trust us.
                        </p>
                      </li>
                      <li>
                        <h3 className="text-lg font-semibold leading-6 text-gray-900">
                      ...
                      <li>
                        ...
                        <p className="mt-4 text-sm text-gray-700">
                          ...
                          trading, not us. We’re just giving you the tips and
                          some tools to make trades. We’re not doing anything
                          wrong here.
                        </p>
                      </li>
                    </ul>
                  ...
                  <li>
                    <ul role="list" className="space-y-10">
                      <li>
                        <h3 className="text-lg font-semibold leading-6 text-gray-900">
                          Do the people giving you tips realize what they are
                          doing?
                        </h3>
                        <p className="mt-4 text-sm text-gray-700">
                          Again I would argue this isn’t really our
                          responsibility. People make their own choices. If they
                          don’t research the consequences that’s on them, not on
                          us.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="mt-4 text-sm text-gray-700">
                          Let’s just say it’s not somewhere where the SEC is
                          going to find us.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="mt-4 text-sm text-gray-700">
                          For our free plan, the age limit is based on the
                          minimum age to trade in your country of residence. Our
                          VIP plan uses advanced transaction anonymization
                          though, so you can use that plan even if you’re 9
                          years old. Or a dog.
                        </p>
                      </li>
                    </ul>
                  ...
                  <li>
                    <ul role="list" className="space-y-10">
                      <li>
                        ...
                        <p className="mt-4 text-sm text-gray-700">
                          Honestly we were surprised too, but eventually we
                          found out that the app reviewer found the app so
                          compelling they approved it just so they could use it
                          themselves.
                        </p>
                      </li>
                      <li>
                        <h3 className="text-lg font-semibold leading-6 text-gray-900">
                          How do I explain the money I withdraw from Pocket to
                          the IRS?
                        </h3>
                        <p className="mt-4 text-sm text-gray-700">
                          This feels like one-hundred percent a you problem.
                          Pocket is not responsible in any way for your tax
                          returns.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="mt-4 text-sm text-gray-700">
                          Contact us with some details about your industry and
                          the type of access you have to apply for an insider
                          account. Once approved, we’ll send you a guide on
                          collecting insider information without being detected
                          at work.
                        </p>
                      </li>
                    </ul>
