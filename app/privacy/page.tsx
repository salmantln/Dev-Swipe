...
export const metadata: Metadata = {
  title: "Privacy | DevSwipe",
  description:
    "Privacy page of DevSwipe",
  ...
  return (
    <div className="relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[40rem] prose-sm prose prose-slate prose-a:font-semibold prose-a:text-primary hover:prose-a:text-primary">
          <p className="mb-5 dark:text-gray-400">
            This privacy policy (&quot;Policy&quot;) outlines how DevSwipe (&quot;we&quot;, &quot;us&quot;,
            &quot;our&quot;) collects, protects, and utilizes personally identifiable
            information (&quot;Personal Information&quot;) you (&quot;User&quot;, &quot;you&quot;, &quot;your&quot;) may
            provide on the DevSwipe website or through using our app
            (collectively, &quot;Service&quot;). This Policy details your rights regarding
            our use of your Personal Information and how you can access and
            update this information. It does not cover practices of entities we
            don&apos;t own/control, or individuals not employed/managed by us.
          </p>
          <div>
            ...
            <p className="mb-5 dark:text-gray-400">
              ...
              able to login to the Website and access any purchased DevSwipe
              products.
            </p>
          </div>
          <br />
          ...
          <p className="mb-5 dark:text-gray-400">
            ...
            DevSwipe does not control Paddle or its collection or use of
          ...
          <p className="mb-5 dark:text-gray-400">
            ...
            the products you have purchased from DevSwipe.
          </p>
          <p className="mb-5 dark:text-gray-400">
          ...
          <p className="mb-5 dark:text-gray-400">
            ...
            email at{" "}
            <a href="mailto:devswipe.app@gmail.com">devswipe.app@gmail.com</a>.
          ...
          <p className="mb-5 dark:text-gray-400">
            ...
            never to provide Personal Information through our Website without
            their permission. If you have reason to believe that a child under
            the age of 13 has provided Personal Information to us through our
          ...
          <p className="mb-5 dark:text-gray-400">
            ...
            email at{" "}
            <a
              className="mb-5 dark:text-primary"
    ...
    //    <p className="mb-5 dark:text-gray-400">Last updated: [Date]</p>

    //    <p className="mb-5 dark:text-gray-400">Welcome to our Privacy Policy page! When you use our web services, you trust us with your information. This Privacy Policy is meant to help you understand what data we collect, why we collect it, and what we do with it. This is important; we hope you will take time to read it carefully.</p>

    //   <h2 className="text-lg sm:text-xl font-semibold mb-2 dark:text-white">Information Collection And Use</h2>
    //    <p className="mb-5 dark:text-gray-400">We collect several different types of information for various purposes to provide and improve our Service to you.</p>

    //   <h2 className="text-lg sm:text-xl font-semibold mb-2 dark:text-white">Types of Data Collected</h2>
    //   <h3>Personal Data</h3>
    //    <p className="mb-5 dark:text-gray-400">While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to:</p>
    //   <ul>
    //     <li>Email address</li>
