...
<div id="docs-sidebar" className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700">
  ...
  <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
    ...
    // <div
    //   classNameName={`sm:none duration-175 linear fixed !z-50 flex min-h-full flex-col bg-white pb-10 shadow-2xl shadow-white/5 transition-all dark:!bg-navy-800 dark:text-white md:!z-50 lg:!z-50 xl:!z-0 ${
    //     open ? 'translate-x-0' : '-translate-x-96 xl:translate-x-0'
    //   }`}
    // >
    //   <span
    //     classNameName="absolute right-4 top-4 block cursor-pointer xl:hidden"
    //     onClick={() => setOpen(false)}
    //   >
    //     <HiX />
    //   </span>

    //   <div classNameName={`mx-[56px] mt-[50px] flex items-center`}>
    //     <div classNameName="ml-1 mt-1 h-2.5 font-poppins text-[26px] font-bold uppercase text-navy-700 dark:text-white">
    //       Horizon <span classNameName="font-medium">FREE</span>
    //     </div>
    //   </div>
    //   <div classNameName="mb-7 mt-[58px] h-px bg-gray-300 dark:bg-white/30" />
    //   {/* Nav item */}

    //   <ul classNameName="mb-auto pt-1">
    //     <Links routes={routes} />
    //   </ul>
