...
const GptSidebar = ({ onSectionSelect }: { onSectionSelect: any }) => {
  return (
    // <aside className="fixed inset-y-0 left-0 w-64 bg-gray-800 text-white h-screen">
    //   <div className="p-5">
    //     <h2 className="text-lg font-semibold">Sidebar</h2>
    //     <ul className="pt-20 pl-11">
    //       <li onClick={() => onSectionSelect("link1")}>Link 1</li>
    //       <li onClick={() => onSectionSelect("link2")}>Link 2</li>
    //       <li onClick={() => onSectionSelect("link3")}>Link 3</li>
    //     </ul>
    //   </div>
    // </aside>
  ...
  >
    <div className="px-6">
      <a
        ...
        aria-label="Brand"
      >
        <Image src={"/img/logo.svg"} alt={"devswipe_logo"} width={50} height={50}/>
      </a>
    </div>
    ...
    >
      <ul className="space-y-1.5">
        <li onClick={() => onSectionSelect("link1")}>
          <a
        ...
        <li className="hs-accordion" id="users-accordion" onClick={() => onSectionSelect("link2")}>
          <button
            type="button"
        ...
        <li className="hs-accordion" id="account-accordion" onClick={() => onSectionSelect("link3")}>
          <button
            type="button"
            className="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
          >
        ...
        <li className="hs-accordion" id="projects-accordion" onClick={() => onSectionSelect("link4")}>
          <button
            type="button"
            className="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
          >
        ...
        <li onClick={() => onSectionSelect("link5")}>
          <a
        ...
        <li onClick={() => onSectionSelect("link6")}>
          <a
            className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            href="#"
          >
